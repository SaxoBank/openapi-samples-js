...
(function () {
    ...
    function getAccessRights() {
        ...
        const operations = {
            ...
            "OAPI.OP.TakePriceSession": "You can upgrade to Premium price feed (DataLevel).",
            "OAPI.OP.TakeTradeSession": "You can upgrade to FullTradingAndChat mode (TradeLevel).",
