...
(function () {
    ...
    function getAccessRights() {
        ...
        const operations = {
            ...
            "OAPI.OP.ManageInterAccountTransfers": "Allows transfers between your accounts.",
            "OAPI.OP.ManageInterAccountTransfersOnOwnedClients": "Allows transfers between accounts of the same client, to be performed for clients in hierarchy.",
            ...
            "OAPI.OP.TakePriceSession": "You can upgrade the DataLevel of your session to Premium mode.",
            "OAPI.OP.TakeTradeSession": "You can upgrade the TradeLevel of your session to FullTradingAndChat mode.",
