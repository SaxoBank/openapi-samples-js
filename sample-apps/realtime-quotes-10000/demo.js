...
(function () {
    ...
    function find() {
        ...
        function requestInstrumentList(urlOfNextPage) {
            ...
            let url;
            if (urlOfNextPage === "") {
                url = demo.apiUrl + "/ref/v1/instruments?AssetTypes=" + assetType + "&IncludeNonTradable=true&$top=1000" + "&AccountKey=" + encodeURIComponent(demo.user.accountKey) + "&Keywords=" + encodeURIComponent(keywords);
