...
function startListener() {
    ...
    function parseStreamingMessage(data) {
        try {
            ...
            switch (refId) {
            case "MyOrderEvent":
                console.log("Streaming order event " + messageId + " received: " + JSON.stringify(block, null, 4));
                break;
            case "MyPositionEvent":
                console.log("Streaming position event " + messageId + " received: " + JSON.stringify(block, null, 4));
                break;
            case "_heartbeat":
                break;
            default:
