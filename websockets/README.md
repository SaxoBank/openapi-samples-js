...
```javascript
    ...
    const streamerUrl = "wss://sim-streaming.saxobank.com/sim/oapi/streaming/ws/connect?authorization=" + encodeURIComponent("BEARER " + accessToken) + "&contextId=" + contextId;
